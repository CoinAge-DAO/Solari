...
#include "config/solari-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatSolariURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + SolariUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatSolariURI(info));
}
