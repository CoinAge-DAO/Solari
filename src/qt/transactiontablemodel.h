...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, SolariUnits::SeparatorStyle separators=SolariUnits::separatorStandard) const;
