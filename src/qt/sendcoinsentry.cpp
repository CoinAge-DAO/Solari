    ...
    model(0)
{
    ...
    // normal solari address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying solari address(es)
    ui->payTo_is->setFont(GUIUtil::solariAddressFont());
...
void SendCoinsEntry::clear()
{
    ...
    // update the display unit, to not use the default ("SRI")
    updateDisplayUnit();
}
