...
#ifndef SOLARI_RPCPROTOCOL_H
#define SOLARI_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Solari is not connected
