// Copyright (c) 2013-2014 The Solari Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CSolariAddress demoAddress = CSolariAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CSolariAddress setaccountDemoAddress = CSolariAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CSolariAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CSolariAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
