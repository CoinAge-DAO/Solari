...
Run with the -testnet option to run with "play solaris" on the test network, if you
...
Solari Core is a multithreaded application, and deadlocks or other multithreading bugs
