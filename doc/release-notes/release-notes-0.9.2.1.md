Solari Core version 0.9.2.1 is now available from:

  https://solari.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SRI to 0.01 SRI
...
- Fix "Start solari on system login"
