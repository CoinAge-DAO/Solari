Solari version 0.5.4 is now available for download at:
http://sourceforge.net/projects/solari/files/Solari/solari-0.5.4/
...
http://gitorious.org/solari/solarid-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Solari-Qt notifications under Growl 1.3.
Increase required age of Solari-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSolari properly when installing Solari-Qt over it. (Windows)
