Solari-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/solari/files/Solari/solari-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Solari
...
New/changed settings (command-line or solari.conf file)
--------------------------------------------------------
