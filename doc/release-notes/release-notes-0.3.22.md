Download URL: https://sourceforge.net/projects/solari/files/Bitcoin/solari-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 SRI fee schedule (users still pay 0.01 SRI per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #solari00 - #solari99
