...
unlocked to sign the Solari-Qt.app bundle.
...
allowing somebody to distribute a Solari-Qt.app or solari-qt-setup.exe with a valid
...
that the solari-qt.exe file inside the installer had not been tampered with.
