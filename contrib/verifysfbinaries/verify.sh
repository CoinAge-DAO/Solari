...
###   This script attempts to download the signature file SHA256SUMS.asc from solari.org
...
WORKINGDIR="/tmp/solari"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://solari.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://solari.org/bin/"
VERSIONPREFIX="solari-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'solari-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[solari-]<version>-[rc[0-9]] (example: solari-0.9.2-rc1)"
   echo "wget output:"
